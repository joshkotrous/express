...
// Helper to remove dangerous prototype keys from parsed query objects
function removePrototypeKeys(obj) {
  if (!obj || typeof obj !== 'object') return;
  var dangerousKeys = ['__proto__', 'constructor', 'prototype'];
  for (var i = 0; i < dangerousKeys.length; i++) {
    if (Object.prototype.hasOwnProperty.call(obj, dangerousKeys[i])) {
      delete obj[dangerousKeys[i]];
    }
  }
  // Recursively clean nested objects
  for (var key in obj) {
    if (Object.prototype.hasOwnProperty.call(obj, key) && typeof obj[key] === 'object' && obj[key] !== null) {
      removePrototypeKeys(obj[key]);
    }
  }
}
